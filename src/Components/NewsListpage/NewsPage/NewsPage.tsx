...
export const NewsPage = () => {
    ...
    const news = useSelector(selectNews).find( (n) => n.id === Number(newsId))
    ...
    return (
        <div className={s.newsPage}>
            ...
            <div className={s.newsPage_container}>
                ...
                <img className={s.photo} src={news?.photo || noPhoto} alt={news?.title} />
                <p className={s.description}>{news?.description}</p>
            </div>
        </div>
    )
}